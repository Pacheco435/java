...
public class ValidarUsuarioAction extends ActionSupport {
    ...
    public String execute() {
        if ("admin".equals(this.usuario)) {
            addActionMessage(getText("usuario.valido"));//mensaje  informativo
    ...
    public void validate() {
        if (this.usuario == null || "".equals(this.usuario.trim())) {//trim para que quite caracteres vacios al moent de hacer el envio al formulario
