...
public class PruebaJPQL {
    ...
    public static void main(String[] args) {
        ...
        //3. Consulta de un objeto persona filtrado por nombre 
        jpql = "select p from Persona p where p.nombre = 'Karla'";
        personas = em.createQuery(jpql).getResultList();
        //mostrarPersonas(personas);
        
        //4. Consulta con datos individuales conocido como arreglo TUPLA de tipo object de tres columnas 
        log.debug("\n4. Consulta de datos individuales, se crea un arreglo (tupla) de tipo obkect de 3 columnas ");
        jpql = "select p.nombre as Nombre, p.apellido as Apellido, p.email as Email from Persona p ";
        iter = em.createQuery(jpql).getResultList().iterator();
        while(iter.hasNext()){//: Devuelve true si aún quedan elementos por recorrer y false en caso contrario
        ...
        //5. Obtener el objeto Persona y el Id se crea el arreglo de tipo abject con dos columnas 
        log.debug("\n. 5. Obtener el objeto Persona y el Id se crea el arreglo de tipo abject con dos columnas ");
        ...
        log.debug("\n9. Cuenta los nombres de las personas que son distintos ");
        ...
        //10. Obtiene el objeto persona con id igual al paremetro proporcionado
        log.debug("\n10. Obtiene el objeto persona con id igual al paremetro proporcionado");
        int idPersona = 1;
        ...
        //11. Obtiene as personas que contengan una letra A en el nombre sin importar si es mayuscula o minuscula
        log.debug("\n11. Obtiene as personas que contengan una letra A en el nombre sin importar si es mayuscula o minuscula" );
        jpql = "select p from Persona p where upper(p.nombre) like upper(:parametro)";
        String parametroString = "%a%";//es el caracter que se utiliza para el like 
        q = em.createQuery(jpql);
        ...
        log.debug("\n15 uso de join con lazi Loading ");
        jpql = "select u from Usuario u join u.persona p";//lazi es una carga retardada
        ...
        jpql = "select u from Usuario u left join fetch u.persona";//fetch recupera los datos en este momento y es tipo eager loading
        usuarios  =em.createQuery(jpql).getResultList();
        mostrarUsuarios(usuarios);
    }
