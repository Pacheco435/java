...
public class Asignacion implements Serializable{
    ...
    @Column(name = "id_asignacion")//nombre real vs el nombre de la llave ne Java 
    private Integer idAsignacion;
    
    private  String turno;
    
    
    @JoinColumn(name="id_alumno",referencedColumnName = "id_alumno")//foranea, primaria 
    @ManyToOne    
    private Alumno alumno;
    
    @JoinColumn(name="id_curso",referencedColumnName = "id_curso")//foranea, primaria 
    @ManyToOne    
    private Curso curso;
    ...
    public int hashCode() {
        int hash = 7;
        hash = 47 * hash + Objects.hashCode(this.idAsignacion);
        return hash;
    }
